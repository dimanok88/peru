...
if ($_GET['coID'] == 7) {
	...
	if (isset ($_GET['action']) && ($_GET['action'] == 'success')) {
		...
		$vamTemplate->assign('INPUT_NAME', vam_draw_input_field('name', ($error ? $_POST['name'] : $first_name), 'class="txt"'));
		$vamTemplate->assign('INPUT_EMAIL', vam_draw_input_field('email', ($error ? $_POST['email'] : $email_address), 'class="txt"'));
