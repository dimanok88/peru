...
$box->assign('INPUT_SEARCH', vam_draw_input_field('keywords', 'ПОИСК', 'id="quick_find_keyword" class="txt" onfocus="this.value = \'\';"'));
$box->assign('BUTTON_SUBMIT', vam_image_submit('', '', 'class="submit"'));
